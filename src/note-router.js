  ...
  .post(bodyParser, (req, res, next) => {
    ...
    noteService
      ...
      .then(note => {
        res
          .status(201)
          .location(`postgres://brfebwbluaohdy:08d1425cecd1afafdf782fa501879757bd5e04ad5c2a92386262074e518b9d6a@ec2-50-19-95-77.compute-1.amazonaws.com:5432/debnapqhhptg4q/note/${note.id}`)
          .json({
            id: note.id.toString(),
            name: xss(note.note_name),
            content: xss(note.content),
